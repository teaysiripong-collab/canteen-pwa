...
npm run test:integration  # integration — เขียนจริงลง Postgres (180 tests)
```
...
| 14+ | งาน/แจ้งเตือน, ตรวจนับสต๊อก, ของเสีย, command center, รายงาน + export, Google Sheets sync, security hardening | ⏳ |
