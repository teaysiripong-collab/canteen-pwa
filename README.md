...
src/
  ...
  lib/                     permissions, quantity, units, fefo, costing, purchasing, date, errors, auth, supabase
  config/                  navigation
...
npm run test:integration  # integration — เขียนจริงลง Postgres (165 tests)
```
...
| 13+ | AI copilot, งาน/แจ้งเตือน, ตรวจนับสต๊อก, ของเสีย, command center, รายงาน + export, Google Sheets sync, security hardening | ⏳ |
